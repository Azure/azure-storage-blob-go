...
func (pb PageBlobURL) Create(ctx context.Context, size int64, sequenceNumber int64, h BlobHTTPHeaders, metadata Metadata, ac BlobAccessConditions, cpk ClientProvidedKeyOptions) (*PageBlobCreateResponse, error) {
