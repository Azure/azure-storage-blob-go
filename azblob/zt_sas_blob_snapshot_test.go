...
func (s *aztestsSuite) TestSnapshotSAS(c *chk.C) {
	...
	_, err = burl.Upload(ctx, strings.NewReader(data), BlobHTTPHeaders{ContentType: "text/plain"}, Metadata{}, BlobAccessConditions{}, ClientProvidedKeyOptions{})
	if err != nil {
		c.Fatal(err)
	}
	...
	_, err = fsburl.Upload(ctx, strings.NewReader(data), BlobHTTPHeaders{ContentType: "text/plain"}, Metadata{}, BlobAccessConditions{}, ClientProvidedKeyOptions{})
	if err != nil {
