...
func (f *fakeBlockWriter) CommitBlockList(ctx context.Context, blockIDs []string, headers BlobHTTPHeaders, meta Metadata, access BlobAccessConditions, tier AccessTierType, cpk ClientProvidedKeyOptions) (*BlockBlobCommitBlockListResponse, error) {
