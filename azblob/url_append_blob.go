...
func (ab AppendBlobURL) Create(ctx context.Context, h BlobHTTPHeaders, metadata Metadata, ac BlobAccessConditions, cpk ClientProvidedKeyOptions) (*AppendBlobCreateResponse, error) {
