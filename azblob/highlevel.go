...
func downloadBlobToBuffer(ctx context.Context, blobURL BlobURL, offset int64, count int64,
	...
	if count == CountToEnd { // If size not specified, calculate it
		if initialDownloadResponse != nil {
			...
			dr, err := blobURL.Download(ctx, 0, CountToEnd, o.AccessConditions, false, ClientProvidedKeyOptions{})
			if err != nil {
				return err
			}
	...
	err := DoBatchTransfer(ctx, BatchTransferOptions{
		...
		Operation: func(chunkStart int64, count int64, ctx context.Context) error {
			dr, err := blobURL.Download(ctx, chunkStart+offset, count, o.AccessConditions, false, ClientProvidedKeyOptions{})
			if err != nil {
				return err
			}
...
func DownloadBlobToFile(ctx context.Context, blobURL BlobURL, offset int64, count int64,
	...
	if count == CountToEnd {
		...
		props, err := blobURL.GetProperties(ctx, o.AccessConditions, ClientProvidedKeyOptions{})
		if err != nil {
			return err
		}
