...
type blockWriter interface {
	...
	CommitBlockList(context.Context, []string, BlobHTTPHeaders, Metadata, BlobAccessConditions, AccessTierType, ClientProvidedKeyOptions) (*BlockBlobCommitBlockListResponse, error)
}
...
func (c *copier) close() error {
	...
	var err error
	c.result, err = c.to.CommitBlockList(c.ctx, c.id.issued(), c.o.BlobHTTPHeaders, c.o.Metadata, c.o.AccessConditions, c.o.BlobAccessTier, ClientProvidedKeyOptions{})
	return err
}
